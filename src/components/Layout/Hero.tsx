            ...
            <div className="mx-auto flex py-24 md:flex-row flex-col items-center">
                ...
                <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                    ...
                    <div className="flex w-full md:justify-start justify-center items-end">
                        ...
                        <button className="inline-flex text-white bg-blue-600 border-0 py-2 px-6 focus:outline-none hover:bg-blue-800 rounded text-lg active:bg-blue-400 duration-150 ease-linear">Button</button>
                    </div>
